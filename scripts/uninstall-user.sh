...
rm -f "$speaktext_user_home/.local/bin/speaktext"
rm -f "$speaktext_user_home/.local/libexec/speaktext/speaktext-worker"
...
rmdir "$speaktext_user_home/.local/libexec/speaktext" 2>/dev/null || true
